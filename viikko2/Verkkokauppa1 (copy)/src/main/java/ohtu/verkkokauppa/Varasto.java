...
import java.util.*;
@Component
public class Varasto implements Varastopinta {
    
    private Kirjanpitopo kirjanpitopo;
    private HashMap<Tuote, Integer> saldot;

    @Autowired
    public Varasto(Kirjanpitopo pito) {
        kirjanpitopo = pito;
    ...
    public void otaVarastosta(Tuote t){        
        ...
        kirjanpitopo.lisaaTapahtuma("otettiin varastosta "+t);
    }
    
    public void palautaVarastoon(Tuote t){
        saldot.put(t,  saldo(t.getId())+1 );
        kirjanpitopo.lisaaTapahtuma("palautettiin varastoon "+t);
    }    
